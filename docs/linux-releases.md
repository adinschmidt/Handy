...
Select `main` as the target when creating a new tag.
...
`GITHUB_TOKEN` is required. Update checks and automatic installation are disabled in this fork. Install
updates by downloading the new package. The upstream manual **Release**
